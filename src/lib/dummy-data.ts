...
export const dummyPolls: Poll[] = [
  ...
  { id: 2, creatorId: 2, question: "Pizza for lunch?", options: [{ id: 1, text: "Nah, something healthy", votes: 150 }, { id: 2, text: "Yes, always pizza", votes: 250 }], type: 'standard', createdAt: now.toISOString(), durationMs: fiveMinutes },
  { id: 3, creatorId: 3, question: "Should I get bangs?", options: [{ id: 1, text: "Risky, think it over", votes: 112 }, { id: 2, text: "Yes, live your life!", votes: 88 }], type: 'standard', createdAt: now.toISOString(), durationMs: oneHour },
  ...
  { id: 5, creatorId: 12, question: "Cats or Dogs?", options: [{ id: 1, text: "Cats are elegant overlords", votes: 980 }, { id: 2, text: "Dogs are man's best friend", votes: 1024 }], type: 'standard', createdAt: now.toISOString(), durationMs: sevenDays },
  ...
  { id: 7, creatorId: 22, question: "Coffee or Tea?", options: [{ id: 1, text: "Tea is a warm hug", votes: 543 }, { id: 2, text: "Coffee is my fuel", votes: 765 }], type: 'standard', createdAt: now.toISOString(), durationMs: oneHour },
  { id: 8, creatorId: 13, question: "Move to a new city or stay here?", options: [{ id: 1, text: "Home is where the heart is", votes: 210 }, { id: 2, text: "New adventure!", votes: 190 }], type: 'standard', createdAt: now.toISOString(), durationMs: sevenDays },
  { id: 9, creatorId: 14, question: "Work from home or in the office?", options: [{ id: 1, text: "I miss the office buzz", votes: 400 }, { id: 2, text: "WFH forever", votes: 1200 }], type: 'standard', createdAt: now.toISOString(), durationMs: oneDay },
  ...
  // 30 more two-option polls (previously 3 and 4 options)
  { id: 41, creatorId: 4, question: "Which streaming service is better value?", options: [{ id: 1, text: "Netflix", votes: 450 }, { id: 2, text: "HBO Max", votes: 400 }], type: 'standard', createdAt: now.toISOString(), durationMs: oneDay },
  { id: 42, creatorId: 15, question: "Better starter Pokemon type?", options: [{ id: 1, text: "Fire (Charmander)", votes: 550 }, { id: 2, text: "Water (Squirtle)", votes: 480 }], type: 'standard', createdAt: now.toISOString(), durationMs: threeDays },
  { id: 43, creatorId: 24, question: "Console war: PlayStation or Xbox?", options: [{ id: 1, text: "PlayStation", votes: 800 }, { id: 2, text: "Xbox", votes: 650 }], type: 'standard', createdAt: now.toISOString(), durationMs: sevenDays },
  ...Array.from({ length: 17 }, (_, i) => ({
    id: 44 + i,
    creatorId: (i % 30) + 1,
    question: `Another binary choice poll #${i + 1}`,
    options: [
  ...
  { id: 61, creatorId: 5, question: "Which 'House' from Game of Thrones is more noble?", options: [{ id: 1, text: "Stark", votes: 900 }, { id: 2, text: "Targaryen", votes: 1100 }], type: 'standard', createdAt: now.toISOString(), durationMs: sevenDays },
  ...Array.from({ length: 9 }, (_, i) => ({
    id: 62 + i,
    creatorId: (i % 30) + 1,
    question: `A simple A/B Test Poll #${i + 1}`,
    options: [
  ...
  { id: 71, creatorId: 18, question: "I'm thinking of losing my virginity. Should I use protection?", description: "This is a big step for me and I want to make the right choice. Please give me your honest opinion.", options: [{ id: 1, text: "No, raw is better if you trust them.", votes: 150 }, { id: 2, text: "Yes, safety first is non-negotiable.", votes: 2300 }], type: '2nd_opinion', createdAt: now.toISOString(), durationMs: threeDays },
  { id: 72, creatorId: 19, question: "Found out my spouse cheated. Should I stay or leave?", description: "My world is shattered. We have kids, a house... everything. But the trust is gone. What would you do?", options: [{ id: 1, text: "Stay and try to work it out.", votes: 900 }, { id: 2, text: "Leave. You deserve better.", votes: 1800 }], type: '2nd_opinion', createdAt: now.toISOString(), durationMs: sevenDays },
  { id: 73, creatorId: 20, question: "Should I quit my stable job to chase my dream?", description: "My dream is to be a painter, but it's a huge risk. My job is secure but it drains my soul.", options: [{ id: 1, text: "No, be realistic and keep the job.", votes: 850 }, { id: 2, text: "Yes, follow your passion!", votes: 650 }], type: '2nd_opinion', createdAt: now.toISOString(), durationMs: threeDays },
